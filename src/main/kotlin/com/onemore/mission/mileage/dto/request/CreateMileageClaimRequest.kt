...
data class CreateMileageClaimRequest(

    val vehicleRequestId: Long? = null,
    ...
    @field:NotEmpty
    @field:Valid
    val travelDetails: List<MileageTravelDetailRequest>
)

data class MileageTravelDetailRequest(
